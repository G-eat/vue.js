      ...
      <form class="col s12" @submit.prevent='updateUser'>
        <div class="row">
          ...
          <div class="input-field col s2">
            ...
            <button type="submit" class='waves-effect waves-light btn' name="updatebutton">Update</button>
          </div>
        </div>
      </form>
      <div class="input-field col s2">
        <button @click='cancel' type="submit" class='waves-effect waves-light btn grey' name="cancel">Cancel</button>
      </div>
    </div>
